 ...
 * Annotation here would be noise (silence where
 ...
 *
 * Precondition: n > 0. n == 0 causes unsigned wraparound on size_t.
 *               Enforced structurally: guard returns GR_1(0) for n <= 1.
 * Contract: {{0 [ (arr,n) (AS/--\WAS) arr permuted ] 1}}
 *   Z: n <= 1 -- trivially permuted, no shuffle needed
