 ...
 * Contract: -- (procedural: sets abort_flag; no data mapping)
 ==================================================================
 */
 ...
 * Contract: {{0 [ BB84Ctx* (AS/--\WAS) bool ] 1}}
 ==================================================================
 */
 ...
 * Contract: {{0 [ uint64_t* (AS/++\PLUS) *out filled ] 1}}
 ==================================================================
 */
 ...
 * Contract: {{0 [ (void*,size_t) (AS/++\PLUS) buf filled ] 1}}
 ==================================================================
 */
 ...
 * Contract: {{0 [ (uint64_t,uint64_t) (AS/--\WAS) bool ] 1}}
 ==================================================================
 */
 ...
 * Precondition: n > 0. Enforced: guard for n <= 1 returns GR_1(0).
 * Contract: {{0 [ (size_t*,size_t) (AS/--\WAS) arr permuted ] 1}}
 ==================================================================
 */
GateResult fisher_yates(size_t *arr, size_t n)
{
    /* Precondition: arr != nullptr (caller's responsibility).
     * n == 0 would wrap size_t to SIZE_MAX -- guard explicitly.
     * n == 1 is a no-op: one element has exactly one permutation. */
    if (n <= 1u) return GR_1(0);
